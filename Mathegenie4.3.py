...
# VERSION: 4.3 (Implementierung der Ergebnis-Exportfunktion)
# ==============================================================================
#
# Eine adaptive Tkinter-Anwendung zur Durchführung und Aufzeichnung von
# Mathematikübungen. Diese Version erweitert die Fortschrittsseite um die
# Möglichkeit, Lern- und Testergebnisse zu exportieren.
#
# Haupt-Features der Version 4.3:
# 1. Daten-Export: Implementierung einer Funktion zum **Export aller gespeicherten
#    Ergebnisse** aus der Datenbank in ein externes Format (z.B. CSV oder JSON).
# 2. Tkinter File Dialog: Nutzung von `tkinter.filedialog` zur Auswahl des
#    Speicherorts und des Dateinamens für den Export.
# 3. Fortschritts-Analyse: Erweiterung der Fortschrittsseite um einen
#    "Exportieren"-Button neben den Visualisierungen (V4.2).
# 4. Stabile Basis: Alle Kernfunktionen, insbesondere die Visualisierung (V4.2)
#    und der Halbjahrestest (V4.0/4.1), bleiben stabil und funktionsfähig.
#
